...
df_developed= df[df['Status']=='Developed'].groupby(['Status'])(df.select_dtypes(include='number').columns).mean()  # get the statistics for each status to display on dashboard
df_developing= df[df['Status']=='Developing'].groupby(['Status'])(df.select_dtypes(include='number').columns).mean() 
